...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'AwesomeBundle\\Controller\\DefaultController::indexAction',  '_route' => 'home',);
        }

        if (0 === strpos($pathinfo, '/p')) {
            // profile
            if ($pathinfo === '/profile') {
                return array (  '_controller' => 'AwesomeBundle\\Controller\\DefaultController::profileAction',  '_route' => 'profile',);
            }
        ...
        if (0 === strpos($pathinfo, '/message')) {
            ...
            // message_new
            if (0 === strpos($pathinfo, '/message/new') && preg_match('#^/message/new/(?P<ticketId>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_message_new;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'message_new')), array (  '_controller' => 'AwesomeBundle\\Controller\\messageController::newAction',));
            }
            not_message_new:
